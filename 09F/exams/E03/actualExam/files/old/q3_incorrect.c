...
double averageOfIntArray(int *array, int size)
{
  ...
  // This next line has a problem.  It works some of the time, but
  // not always.  Can you figure out why?

  avg = total/size; // WRONG!  Why?  Run it, and see which test case fails..
