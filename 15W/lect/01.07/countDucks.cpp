...
#include <iostream> // for input and output from the keyboard (cin and
		    // cout and endl)
...
{
  ifstream ifs; // the stream we will use for the input file. our
		// input file is dope it rocks conrad's world
