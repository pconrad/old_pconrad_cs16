...
void checkExpect(char *msg, int check, int expect)
{
  printf("Testing %s with expected value: %d ...",msg,expect);
  if (check==expect)
    printf("Test passes!\n");
  else
...
int main()
{
  ...
  checkExpect("areaOfSquare(3)", areaOfSquare(3),9);
  checkExpect("areaOfSquare(0)", areaOfSquare(0),0);
  checkExpect("areaOfSquare(7)", areaOfSquare(7),49);
  checkExpect("areaOfSquare(9)", areaOfSquare(9),81);
  checkExpect("areaOfSquare(17)",areaOfSquare(17),289);
