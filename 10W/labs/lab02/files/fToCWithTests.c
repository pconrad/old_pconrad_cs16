...
// P. Conrad for CS16, Winter 2010, UCSB CS Dept.
...
int main()
{
  ...
  failures += checkExpectDouble("fToC(32.0)",fToC(32.0),0.0,tol);
  failures += checkExpectDouble("fToC(212.0)",fToC(212.0),100.0,tol);
  failures += checkExpectDouble("fToC(68.0)",fToC(68.0),20.0,tol);
  failures += checkExpectDouble("fToC(-40.0)",fToC(-40.0),-40.0,tol);
