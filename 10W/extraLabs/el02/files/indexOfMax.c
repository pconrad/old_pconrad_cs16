...
// In this function, we take advantage of an extension to standard C
// that permits declarations of local variables to appear anywhere in the code
// (Not permitted in "old school" C, but ok in newer versions.)
