...
int testMultiplyPairwise() {
...

  {
    ...
    failures += checkExpectIntArray("multiplyPairwise(a,b,abResult,4)", 
...

  {
    ...
    failures += checkExpectIntArray("multiplyPairwise(a,c,acResult,4)", 
...

  {
    ...
    failures += checkExpectIntArray("multiplyPairwise(a,d,adResult,4)", 
...

  {
    ...
    failures += checkExpectIntArray("multiplyPairwise(b,c,bcResult,4)",
  ...
  
  {
    ...
    failures += checkExpectIntArray("multiplyPairwise(c,d,cdResult,4)", 
