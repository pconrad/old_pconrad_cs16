...
int testCopyOdds()
{
  ...
  failures += checkExpectInt("copyOdds(a,aOdds,3)--checking return--",
			     aNumOdds, 2);
  failures += checkExpectIntArray("copyOdds(a,aOdds,3)--checking array---",
  ...
  failures += checkExpectInt("copyOdds(b,bOdds,5)--checking return--",
			     bNumOdds, 3);
  failures += checkExpectIntArray("copyOdds(b,bOdds,5)--checking array---",
  ...
  failures += checkExpectInt("copyOdds(c,cOdds,3)--checking return--",
			     cNumOdds, 0);
