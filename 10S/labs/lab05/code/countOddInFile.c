...
// P. Conrad for CS16, Spring 2010    Version for lab05

// This version of the countOddInFile program 
// shows how we can just put the function prototypes
// for isOdd() and countOdd() in this file, and have the function 
// definitions be in the file oddFunctions.c
// We compile with:
//  cc oddFunctions.c countOddInFile.c -o countOddInFile
// And run with
//  ./countOddInFile
