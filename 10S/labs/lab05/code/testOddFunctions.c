// P. Conrad for CS16, Spring 2010, lab05

// testOddFunctions.c   test-driven development, counting in an array
// This program shows how we can just put the function prototypes
// for isOdd() and countOdd() in this file, and have the function 
// definitions be in the file oddFunctions.c
// We compile with:
//  cc oddFunctions.c testOddFunctions.c -o testOddFunctions
// And run with
//  ./testOddFunctions
