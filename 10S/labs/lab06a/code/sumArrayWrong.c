// sumArrayWrong.c   Illustration of a segmentation fault
...
int sumArray(int *a, int n)
{
  ...
  // @@@ BUG ALERT: there is a bug on the line marked below
  // @@@ Depending on your font, it can be hard to spot
  // @@@ but once you see it, the error is obvious if you
  // @@@ are familiar with the way that for loops are usually used
